...
function apply(ctx, config = {}) {
	const { enabled = true, scope = "declared", levels = DEFAULT_LEVELS, verify = false, maxTokens = 384000, contextWindow = 1000000, thinkingFormat = false, defaultEffort = "medium", supportsDeveloperRole = false } = config;
	if (!enabled) return;
